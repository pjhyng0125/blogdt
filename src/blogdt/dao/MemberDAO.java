...
public class MemberDAO 
{
    ...
    public void insertMember(MemberVO member) throws SQLException, ParseException
    {
        ...
        try {
            ...
            sql.append("insert into member (id, pw, name, birth, major, position, jyear, dept, flag) values");
            sql.append("(?, ?, ?, ?, ?, ?, ?, ?, ?)");        
            /* 
            ...
            pstmt.setString(8, member.getDept());
            pstmt.setByte(9, (byte) member.getFlag());
        ...
        } catch (SQLException | ClassNotFoundException | NamingException sqle) {
            // 오류시 롤백
            conn.rollback(); 
            
            throw new RuntimeException(((Throwable) sqle).getMessage());
        } finally {
